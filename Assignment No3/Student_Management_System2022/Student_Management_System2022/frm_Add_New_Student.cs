...
namespace Student_Management_System2022
{
    public partial class frm_Add_New_Student : Form
    {
        ...
        private void btn_Save_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("First Fill All Compulsary Fields");
            }
        ...
        {
            DialogResult Res = MessageBox.Show("Are You Shoure Want to Log Out????", "Log Out", MessageBoxButtons.YesNo, MessageBoxIcon.Information);
